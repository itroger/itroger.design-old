...
const Index = () => {
  return (
    <div className="flex flex-col justify-center items-center gap-8 h-full">
      ...
      <button className="px-10 py-3 font-semibold text-base text-white dark:text-black hover:text-black hover:dark:text-white bg-black dark:bg-white border border-black dark:border-white hover:bg-white hover:dark:bg-black rounded focus:ring">
        Get Started
      </button>
